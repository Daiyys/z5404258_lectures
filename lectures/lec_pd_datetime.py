...
y = f'Date in day/month/year format is: {dt_now.day}/{dt_now.month}/{dt_now.year} '
print(s)
print(y)
#
...
two_little_ago = dt.datetime(2021, 8, 21, 13, 27, 1, 283311)
print(two_little_ago)
#
